...
module.exports = {
  ...
  adminOnly (req, res, next) {
    ...
    if (
      ...
      process.env.BOSS_DEV === 'localhost'
    ) {
      next()
    } else {
  ...
  ensureLoggedInGithub (req, res, next) {
    ...
    if (
      ...
      res.render('error', {
        error:
          'You need to be logged in for this. Also make sure you have linked your github account at account.codingblocks.com'
      })
    }
  }
}
